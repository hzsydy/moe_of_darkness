...
country = {
	...
	GOLD_TO_CASH_RATE = 2.5, -- Amount of money generated per gold unit
	GOLD_TO_WORKER_PAY_RATE = 2.5, -- Multiplier for how much money gold pays to pops
	...
	BASE_MONTHLY_DIPLOPOINTS = 0.1, -- Base value gain for diplomatic actions each month
	...
	SUPPRESSION_POINTS_GAIN_BASE = 100, -- monthly gain with max bureaucrats
	...
	INVESTMENT_SCORE_FACTOR = 0.0001, -- how much foreign investment money counts towards your industry score
	...
	TECH_YEAR_SPAN = 300,
	TECH_FACTOR_VASSAL = 0.01, -- cost reduction factor if overlord has research the tech
	MAX_SUPPRESSION = 1000,
	...
	NAVAL_BASE_NON_CORE_SUPPLY_SCORE = 0.5, -- modifier for supply score for naval bases that are not in core provinces.
	COLONIAL_POINTS_FROM_SUPPLY_FACTOR = 1,
	COLONIAL_POINTS_FOR_NON_CORE_BASE = 1,
	MOBILIZATION_SPEED_BASE = 0.1, -- Base speed for raising troops
	...
	COLONIZATION_DAYS_FOR_INITIAL_INVESTMENT = 180,
...
economy = {
	...
	BANKRUPTCY_EXTERNAL_LOAN_YEARS	= 100,
	BANKRUPTCY_FACTOR = 0.2,
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 100,
	...
	RGO_SUPPLY_DEMAND_FACTOR_FIRE = 0.5,		-- how fast pops are Fired when there is a low demand
...
military = {
	...
	COMBATLOSS_WAR_EXHAUSTION = 2, -- base war exhastion in combat
	LEADER_MAX_RANDOM_PRESTIGE = 0.1, -- max percent of prestige, when randomizing stats for leaders.
	...
	LEADER_TRANSFER_PENALTY_ON_COUNTRY_PRESTIGE = 0.01, -- country prestige penalty on unassign leader (f.ex if leader has 100% prestige, the country loose 4% of its prestige)
	LEADER_PRESTIGE_LAND_GAIN =0.25, -- extra speed gain on prestige for land combat
	...
	SIEGE_ATTRITION = 2.5, -- fixed attrition on sieging units
	BASE_MILITARY_TACTICS = 1, -- base mil tactics before tech
...
diplomacy = {
	...
	INFAMY_DISARMAMENT = 2,
	INFAMY_DESTROY_FORTS = 0.5,
	INFAMY_DESTROY_NAVAL_BASES = 0.5,
	INFAMY_REPARATIONS = 1,
	...
	PRESTIGE_ADD_TO_SPHERE_BASE = 10,
	PRESTIGE_RELEASE_PUPPET_BASE = 5,
	PRESTIGE_MAKE_PUPPET_BASE = 5,
	PRESTIGE_DISARMAMENT_BASE = 5,
	PRESTIGE_DESTROY_FORTS_BASE = 2,
	PRESTIGE_DESTROY_NAVAL_BASES_BASE = 2,
	...
	ADDWARGOAL_RELATION_ON_ACCEPT = -10,
  ADDWARGOAL_DIPLOMATIC_COST = 0.5,
	...
	CANCELALLIANCE_RELATION_ON_ACCEPT = -100,
	CANCELALLIANCE_DIPLOMATIC_COST = 0,

	CALLALLY_RELATION_ON_ACCEPT = 10,
	CALLALLY_RELATION_ON_DECLINE = -50,
	CALLALLY_DIPLOMATIC_COST = 0.1,

	ASKMILACCESS_RELATION_ON_ACCEPT = 10,
	ASKMILACCESS_RELATION_ON_DECLINE = -10,
	ASKMILACCESS_DIPLOMATIC_COST = 1,
	CANCELASKMILACCESS_RELATION_ON_ACCEPT = -25,
	CANCELASKMILACCESS_DIPLOMATIC_COST = 0.5,

	GIVEMILACCESS_RELATION_ON_ACCEPT = 5,
	...
	CANCELWARSUBSIDY_DIPLOMATIC_COST = 1,

	DISCREDIT_RELATION_ON_ACCEPT = -10,
	DISCREDIT_INFLUENCE_COST = 25,

	EXPELADVISORS_RELATION_ON_ACCEPT = -20,
	...
	BANEMBASSY_RELATION_ON_ACCEPT = -30,
	...
	ADDTOSPHERE_RELATION_ON_ACCEPT = 100,
	ADDTOSPHERE_INFLUENCE_COST = 100,

	REMOVEFROMSPHERE_RELATION_ON_ACCEPT = -100,
	REMOVEFROMSPHERE_INFLUENCE_COST = 100,
	REMOVEFROMSPHERE_PRESTIGE_COST = 10, -- only applied if removing country is sphere leader
	REMOVEFROMSPHERE_INFAMY_COST = 5, -- only applied if removing country is sphere leader

	INCREASEOPINION_RELATION_ON_ACCEPT = 10,
	INCREASEOPINION_INFLUENCE_COST = 50,

	DECREASEOPINION_RELATION_ON_ACCEPT = -25,
	...
	AT_WAR_TENSION_DECAY = -0.25, -- for each potentially interested GP at war (value is if all possible GPs are at war) 
	TENSION_ON_CB_DISCOVERED = 20,
	TENSION_ON_REVOLT = 50,
	TENSION_WHILE_CRISIS = -1.0,
	CRISIS_COOLDOWN_MONTHS = 2,
...
pops = {
	...
	POP_TO_LEADERSHIP = 0.001, -- how much leadership every 1000 officers gives each day.
	...
	LARGE_POPULATION_LIMIT = 100000000,
	LARGE_POPULATION_INFLUENCE_PENALTY_CHUNK = 250000,
},

ai =
{
	COLONY_WEIGHT = 10, -- ai weight for colonising
	...
	PEACE_TIME_MONTHS = 24, -- months of additional AI stubbornness in a war
	...
	MIN_FLEETS = 6, -- Minimum amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions)
